      ...
      <div class="container">
        ...
        <div class="progress-container">
          ...
          <div class="progress-bar">
            ...
            <div class="progress-text">${r.sold} de ${r.total} números vendidos (${Math.round(r.percentage)}%)</div>
          </div>
          <div class="progress-details">
            <p>Números Disponibles: <strong>${r.remaining}</strong></p>
          </div>
        </div>
